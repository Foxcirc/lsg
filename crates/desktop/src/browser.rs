...
#[unsafe(no_mangle)] unsafe extern "C" fn call_window_mouse_motion  (handlers: *const EvlHandlers, state: *mut void, id: crate::Id, point_x: i16, point_y: i16)                             { (unsafe { &*handlers }.window_mouse_motion)(state, id, common::LogicalPoint { x: point_x, y: point_y }) }
#[unsafe(no_mangle)] unsafe extern "C" fn call_window_mouse_down    (handlers: *const EvlHandlers, state: *mut void, id: crate::Id, point_x: i16, point_y: i16, button: crate::MouseButton) { (unsafe { &*handlers }.window_mouse_down)  (state, id, common::LogicalPoint { x: point_x, y: point_y }, button) }
#[unsafe(no_mangle)] unsafe extern "C" fn call_window_mouse_up      (handlers: *const EvlHandlers, state: *mut void, id: crate::Id, point_x: i16, point_y: i16, button: crate::MouseButton) { (unsafe { &*handlers }.window_mouse_up)    (state, id, common::LogicalPoint { x: point_x, y: point_y }, button) }
